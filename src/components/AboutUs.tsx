...
export const AboutUs = () => {
  const tiles: BentoImage[] = [
    { src: image1, width: "col-span-4 col-start-1", height: "row-span-2 row-start-1" },
    { src: image2, width: "col-span-4 md:col-span-3 col-start-5", height: "row-span-1 row-start-1" },
    { src: image4, width: "col-span-3 md:col-span-2 md:col-start-8", height: "row-span-1 md:row-start-1 row-start-3" },
    { src: image3, width: "col-span-4 md:col-span-2 col-start-5", height: "row-span-1 row-start-2" },
    { src: image5, width: "col-span-5 md:col-span-3 col-start-4 md:col-start-7", height: "row-span-1 row-start-3 md:row-start-2" },
  ];
  return (
    <div
      id="aboutUs"
      className="relative min-h-screen flex flex-col space-y-16 items-center animate-fade-in duration-600"
    >
